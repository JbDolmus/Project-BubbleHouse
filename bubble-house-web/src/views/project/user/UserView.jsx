...
import { SweetAlertSuccess, SweetAlertError } from '@/assets/js/sweetAlert';
...
export default function UserView() {
  ...
  const { token, user, errorRedux, message, loading } = useSelector(state => state.user);
  ...
  useEffect(() => {
    if (message === "Actualización exitosa" && token) {
      ...
      navigate('/');
      SweetAlertSuccess("Usuario actualizado con éxito. Por seguridad, inicia sesión nuevamente.");
